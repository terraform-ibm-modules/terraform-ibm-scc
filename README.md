...
| <a name="input_update_scc_settings"></a> [update\_scc\_settings](#input\_update\_scc\_settings) | Set to true to update Event Notification and COS attachments in the existing SCC instance. Ignored when new SCC instance is created. | `bool` | `true` | no |
