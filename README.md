...
| <a name="input_enable_event_notifications_integration"></a> [enable\_event\_notifications\_integration](#input\_enable\_event\_notifications\_integration) | Set to true if using Event Notifications. | `bool` | `false` | no |
