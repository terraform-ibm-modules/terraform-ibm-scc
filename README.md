...
| <a name="input_configure_scc_settings"></a> [configure\_scc\_settings](#input\_configure\_scc\_settings) | Set to true to configure Event Notification and COS to the SCC instance. When used with an existing SCC instance this will override existing settings if set to true. | `bool` | `true` | no |
