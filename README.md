...
| <a name="input_cos_bucket_endpoint"></a> [cos\_bucket\_endpoint](#input\_cos\_bucket\_endpoint) | Cloud Object Storage bucket endpoint, defaults to public endpoint if not passed in. | `string` | `""` | no |
