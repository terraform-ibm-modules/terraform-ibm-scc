...
| <a name="input_en_instance_crn"></a> [en\_instance\_crn](#input\_en\_instance\_crn) | The CRN of Event Notifications instance to be used with SCC instance, required if `var.configure_en_instance` is true | `string` | `null` | no |
